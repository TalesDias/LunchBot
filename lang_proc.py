...
def get_formatted_menu(menu: dict) -> str:
    ...
    question = prompt.format_messages(menu_text=menu_text, mirage_instruction=mirage_line)[1].content

    return chain.invoke({"menu_text": menu_text, "mirage_instruction": mirage_line}), question
